...
import { getUserProfile, updateUserProfile, addUserAddress, getUserAddresses, deleteUserAddress, updateUserAddress, setDefaultAddress, getUserSavedFoods } from "../../controllers/userProfileController";
...
router.get('/me/saved-foods', userAuthMiddleware, getUserSavedFoods);
